<template>
  <svg aria-labelledby="svgLogoTitle" version="1.1" id="logo-thome" class="svg" :class="{ 'light': light }" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
       viewBox="0 0 456.7 107.2" style="enable-background:new 0 0 456.7 107.2;" xml:space="preserve">
    <title id="svgLogoTitle">Thome Legacy Enterprises</title>
    <g id="text-thome">
